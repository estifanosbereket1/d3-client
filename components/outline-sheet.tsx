...
export function OutlineSheet({ item, trigger }: OutlineSheetProps) {
  ...
  // // Log form errors any time they change
  // useEffect(() => {
  //   const unsubscribe = form.watch(() => {
  //     // console.log all form errors on change
  //     if (Object.keys(form.formState.errors).length > 0) {
  //       console.log("Form errors:", form.formState.errors)
  //     } else {
  //       // optional: uncomment to log clear state
  ...
  // // also log errors when formState.errors changes (safer)
  // useEffect(() => {
  //   console.log("Form errors changed:", form.formState.errors)
  ...
  useEffect(() => {
    if (item) {
      ...
      form.setValue("reviewer", (item as any).reviewerId ?? "")
    }
  }, [item])
